        ...
        stage ('king2'){
            steps{
                script{
                    ...
                    sh "sudo cp /var/lib/jenkins/workspace/sample/discovery-server/target/discovery-server-0.0.1-SNAPSHOT.jar /var/lib/docker/tmp/buildkit-mount2920845431/target/"
                }
            }
        }
        stage ('image build'){
